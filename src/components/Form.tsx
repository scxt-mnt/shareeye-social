...
about yourself`}</h1>
                <section className='border-l-4 border-t-4 border-white  z-20 h-[380px] relative flex flex-col justify-center gap-5 pr-[10px] pl-[10px]  '>
                    <section className='border-r-4 border-white  border-white  h-[85px] w-[300px] pl-5 pt-3 -mb-4 z-20   relative '>
                    ...
                    <br />
                    <section className={`border-l-4  h-[85px] w-[300px] pl-5  pt-2 z-20 relative `}>
                    ...
                    <section className='border-l-4 border-white  h-[110px] w-[300px] pl-5 pt-3 z-20 relative'>
