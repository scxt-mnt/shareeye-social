...
const Form = () => {
    ...
    return (
        <>
            ...
            {selector.isLog ? <main className='absolute h-screen w-screen grid place-content-center font-poppins text-lg bg-violet-400'>
                ...
                <h1 className='text-2xl 
                    font-bolds absolute left-[20px] top-10 font-bold text-white whitespace-pre border-b-4 border-violet-300'>{`Please tell us 
about yourself`}</h1>
                <section className='z-20 h-[380px] bg-violet-900 relative flex flex-col justify-center gap-5 pr-[10px] pl-[10px] rounded-lg'>
                    <section className='bg-violet-700 h-[85px] w-[300px] pl-5 rounded-xl pt-3 -mb-4 z-20   relative '>
                        ...
                        <input onFocus={handleNameFocus} onBlur={handleNameBlur} className='nameForm w-[15rem] rounded outline-none absolute left-[27px] top-[30px] ' type='text' /></section>
                    <br />
                    <section className='bg-violet-700 h-[85px] w-[300px] pl-5 rounded-xl pt-2 z-20 relative'>
                    ...
                    <section className='bg-violet-700 h-[110px] w-[300px] pl-5 rounded-xl pt-3 z-20 relative'>
