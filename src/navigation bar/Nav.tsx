  ...
  return (
    <>
      ...
      <nav className="bg-transparent w-screen h-[70px] absolute bg-violet-400 shadow-md shadow-violet-900 flex items-center z-30">
        ...
        <button onClick={handleClick} className='text-6xl absolute right-3 cursor-pointer bg-violet-100  rounded-full font-bold'>
          <h1 className={`text-blue-500 transition-transform duration-1000 ${click ? 'rotate-180 translate-y-[2px]' : 'rotate-0 translate-y-[1px]'}`}>←</h1 ></button>
      </nav>
