...
about yourself`}</h1>
                ...
                <button className={`bg-violet-500 w-[1px] transition-all duration-1000 absolute right-0 bottom-10 font-bold text-white ${name && lastName && aboutBio ? 'pr-[5rem] pl-[2rem]' : ''}`}>Finish</button>
            </main>
                : <h1>auth error</h1>
