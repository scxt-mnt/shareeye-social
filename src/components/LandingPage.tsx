  ...
  return (
    <>
      ...
      <div className='w-screen absolute h-screen z-0 bg-violet-500 '/>
        <figure className='absolute left-[110px] top-[140px] h-auto z-20'>
        ...
        <img src={background} className='h-[360px] w-[200px] bg-white rounded-6xl absolute left-[100px] rounded-full top-[123px] z-10 border '></img>
